...
import TitleDesktop from '../presentational/TitleDesktop'
...
const DesktopHomeLeft = ({ activateDemo }) => {
    ...
    return (
            <LeftPanel bgColor={ 'white' }>
                <div style={ containerDivStyle }>
                    <TitleDesktop marginTop={ 50 } />
                    ...
                    <span style={ addExerciseSpan }>
                        { exercise === 'No exercise selected' ?
                            <BlackButton text='Add exercise' fontSize={ 16 } width={ 130 } height={ 38 } disabled={ true } />:
                            <BlackButton text='Add exercise' fontSize={ 16 } width={ 130 } height={ 38 } handleClick={ addExercise } /> 
                        }
                    </span>
                    ...
                    <div style={ buttonDivStyle }>
                        { user === null
                            ...
                            <span style={ bottomLeftSpan }>
                                <BlackButton text='Log in' fontSize={ 16 } width={ 150 } height={ 56 } handleClick={ () => dispatch(changeCurrentPage('Login')) } />
                                <span style={ orStyle }>or</span>
                                <WhiteButton text='Sign up' fontSize={ 16 } width={ 150 } height={ 56 } handleClick={ () => dispatch(changeCurrentPage('SignUp')) } /><br />
                                to submit your workout.
                            </span>
                            :
                            <BlackButton text='Save session' fontSize={ 16 } width={ 150 } height={ 56 } handleClick={ saveSession } />
                        }
                    </div>
                </div>
            </LeftPanel>
